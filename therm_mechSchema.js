var Factory = function(Schema,mongoose) {
	...
	this.createSchemas = function() {
		...
		this.Parts = mongoose.model('thermalMechanicalParts',Schema);
	}

	this.insertPart = function() {
		var th_m1=new this.Parts({
