var ThermalFactory = function(Schema,mongoose) {
	...
	this.insertPart = function() {
		...
		var th_m4 = new this.thermal_parts({
			...
			Manufacturer:'',
			Reference:'http://www.thermacore.com/thermal-basics/heat-pipe-technology.apx',
		...
		var th_m7a = new this.thermal_parts({
			...
			Manufacturer:'ISIS',
			Reference:'http://www.cubesatshop.com/index.php?page=shop.product_details&product_id=38&flypage=flypage.tpl&pop=0&option=com_virtuemart&Itemid=65',
		...
		var th_m13 = new this.thermal_parts({
			...
			Reference:'http://media.wix.com/ugd/1c8e8f_1a5837e450f1c191203dbf7b3a6a1b82.pdf?dn=2002337A%2BCSD%2BData%2BSheet.pdf',
			Heritage:"Unknown",
			Mass:'3510',
			Power:'0 - Comes with a power subsystem',
			Volume:'3',
		...
		var th_m17a = new this.thermal_parts({
			...
			Reference:'http://www.oh1sa.net/data/satellite/cubesat/P-POD-mk3/P-POD%20Mk%20III%20ICD.pdf',
			Heritage:"Unknown",
			Mass:'Unknown',
			Power:'Unknown',
			Volume:'1',
		...
		var th_m18a = new this.thermal_parts({
			...
			Reference:'http://utias-sfl.net/?page_id=241',
			Heritage:"Unknown",
			Mass:'Unknown',
			Power:'Unknown',
			Volume:'1',
		...
		var th_m20a = new this.thermal_parts({
			...
			Reference:'http://www.astrofein.com/2728/dwnld/admin/52B_Datenblatt_spL_Modification_Homepage.pdf',
			Heritage:"Unknown",
			Mass:'Unknown',
			Power:'5.9',
			Volume:'1',
		...
		var th_m21a = new this.thermal_parts({
			...
			Manufacturer:'ISIS',
			Reference:'http://www.isispace.nl/brochures/ISIS_ISIPOD_Brochure_v.7.11.pdf',
			Heritage:"Unknown",
			Mass:'Unknown',
			Power:'Unknown',
		...
		var th_m25 = new this.thermal_parts({
			...
			Reference:'http://www.nasa.gov/centers/ames/engineering/projects/nlas.html#.U-EoX_mwIvl',
			Heritage:"Unknown",
			Mass:'Unknown',
			Power:'Unknown',
			Volume:'1',
		...
		var th_m30 = new this.thermal_parts({
			...
			Reference:'http://nanoracks.com/wp-content/uploads/Current_edition_of_Interface_Document_for_CubeSat_Customers.pdf',
			Heritage:"Unknown",
			Mass:'Unknown',
			Power:'Unknown',
			Volume:'1',
