	...
	this.insertPart = function() {
		...
		var Inst2=new this.instrument_parts({
			  Type: 'Camera',
			   ...
			   Mass_further:'',
			   Power:0.51, 
			   Power_further:'360-660 mW',
			   Volume:0.4558,
			   Proportions:'91.7x86x57.8',
			   Volume_further:'Designed for 1U cubesat',
		...
		var Inst3=new this.instrument_parts({
			  Type: 'Imaging Spectrometer',
			   ...
			   Mass:350, 
			   Mass_further:'estimate',
			   Power:2, 
			   Power_further:'<2 W peak power',
			   Volume:1,
			   Proportions:'',
		...
		var Inst4=new this.instrument_parts({
			  Type: 'Imaging Spectrometer',
			   ...
			   Mass:150, 
			   Mass_further:'initial estimate',
			   Power:0, 
			   Power_further:'',
			   Volume:0.09,
			   Proportions:'60x50x30',
			   Volume_further:'',
		...
		var Inst5=new this.instrument_parts({
			  Type: 'Imaging Spectrometer',
			   ...
			   Mass:3500, 
			   Mass_further:'estimate, 1.5 kg electronics',
			   Power:5.2, 
			   Power_further:'',
			   Volume:2,
			   Proportions:'',
			   ...
			   T_lo:-300, 
			   T_hi:-300, 
			   Thermal_further:'<180 K, includes cryocooler',
			   Datarate:0, 
			   Cost:0
		});
		var Inst6=new this.instrument_parts({
			  Type: 'Spectrometer',  Name:'Argus 1000 IR Spectrometer (InGaAs)',
			   Manufacturer:'York University, Toronto (developer), sold by cubesatshop',
			   Reference:'http://www.thoth.ca/manuals/Argus%20Owners%20Manual,%20Thoth%20Technology,%20Oct%2010,%20rel%201_03.pdf',
			   ...
			   Volume_further:'',
			   Measurement:'near-IR to short-IR, 1000-1700',
			   Sensitivity:'1000-1700',
			   Resolution:'',
			   Pixels:'',
		...
		var Inst7=new this.instrument_parts({
			  Type: 'Spectrometer',  Name:'Argus 1000 Extended IR Spectrometer (InGaAs)',
			   Manufacturer:'York University, Toronto (developer), sold by cubesatshop',
			   Reference:'http://www.thoth.ca/manuals/Argus%20Owners%20Manual,%20Thoth%20Technology,%20Oct%2010,%20rel%201_03.pdf',
			   Heritage:'Flown on CanX-2, TRL 7-9',
			   Mass:230, 
		...
		var Inst8=new this.instrument_parts({
			  Type: 'Detector',
			   ...
			   T_lo:-300, 
			   T_hi:-300, 
			   Thermal_further:'Must be kept at near 140 K. Cryocooler in development',
			   Datarate:0, 
			   Cost:0
		});
		...
		var Inst23=new this.instrument_parts({
			  Type: 'Particle Detector',
			   ...
			   Volume:0.171,
			   Proportions:'60.5x60',
			   Volume_further:'6.05 cm length, 6 cm diameter',
		...
		var Inst33=new this.instrument_parts({
			  Type: 'Detector',
			   ...
			   T_lo:-300, 
			   T_hi:-300, 
			   Thermal_further:'77 K operating temp',
			   Datarate:0, 
			   Cost:0
		});
		var Inst34=new this.instrument_parts({
			  Type: 'Imaging Spectrometer',
			   ...
			   T_lo:-300, 
			   T_hi:-300, 
			   Thermal_further:'Comes with Stirling Cooler: linear or rotary options',
			   Datarate:0, 
			   Cost:0
		});
		...
		var Inst40=new this.instrument_parts({
			  Type: 'Imaging Spectrometer',
			   ...
			   T_lo:-30, 
			   T_hi:55, 
			   Thermal_further:'Available cooled and uncooled',
			   Datarate:0, 
			   Cost:0
		});
		...
		var Inst46=new this.instrument_parts({
			  Type: 'Spectrometer',  Name:'Broadband IR for CubeSats with High Resolution (BIRCH)',
			   ...
			   Mass_further:'',
			   Power:5, 
			   Power_further:'2 W plus 3 W cryocooler',
			   Volume:1.5,
			   Proportions:'',
			   Volume_further:'',
		...
		var Inst49=new this.instrument_parts({
			  Type: 'Camera',
			   ...
			   Heritage:'',
			   Mass:600, 
			   Mass_further:'total weight including larger cryocooler (K527L), 350 g w/ smaller cryocooler (K562S)',
			   Power:7, 
			   Power_further:'less than',
			   Volume:2,
			   Proportions:'',
			   ...
			   T_lo:-40, 
			   T_hi:70, 
			   Thermal_further:'HgCdTe sensors operate btw 120 K and 150 K, includes cryocooler',
			   Datarate:0, 
			   Cost:0
		});
		...
		var Inst54=new this.instrument_parts({
			  Type: 'Camera',
			   ...
			   Mass_further:'',
			   Power:0.75, 
			   Power_further:'as little as',
			   Volume:0.03,
			   Proportions:'',
			   Volume_further:'as little as 30 cubic cm',
		...
		var Inst59=new this.instrument_parts({
			  Type: 'Camera',
			   ...
			   T_lo:0, 
			   T_hi:0, 
			   Thermal_further:'Liquid nitrogen filled',
			   Datarate:0, 
			   Cost:0
		});
		...
		var Inst62=new this.instrument_parts({
			  Type: 'Camera',
			   ...
			   T_lo:0, 
			   T_hi:0, 
			   Thermal_further:'Includes cooler. Operating temp 80 K',
			   Datarate:0, 
			   Cost:0
		});
