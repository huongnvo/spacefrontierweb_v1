	...
	this.insertPart = function() {
		...
		var Inst4=new this.instrument_parts({
			  Type: 'Imaging Spectrometer',
			   ...
			   Volume:"0.09",
			   Proportions:'6x5x3',
			   Measurement:'Hyperspectral 3D images. No info on spectrum, visible, short-IR, long-IR, mid-IR',
			   Sensitivity:"Unknown",
			   Resolution:'15 nm',
			   Pixels:"Unknown",
			   Objectives:"Unknown",
...
/*		var Inst9=new this.instrument_parts({
		...
		var Inst16=new this.instrument_parts({
			  Type:'Magnetometer',
			   ...
			   Measurement:'+-50,000 nT magnetic',
			   Sensitivity:'0-50000',
			   Resolution:'13 nT',
			   Pixels:"Unknown",
		...
		var Inst18=new this.instrument_parts({
			  Type:'Magnetometer',
			   ...
			   Measurement:'Measures up to 57000 nT. magnetic',
			   Sensitivity:'0-57000',
